...
# from cadnano.gui.views.documentwindow import DocumentWindow       # reference to original cadnano document window;
...
class DocumentController():
    ...
    def __init__(self, document):
        ...
        self._initWindow()
#        app().document_controllers.add(self)       # commented out to jump over error
